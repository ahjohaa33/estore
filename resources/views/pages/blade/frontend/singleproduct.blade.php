    ...
    <div class="header-area" id="headerArea">
        <div class="container h-100 d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            ...
            <div class="page-heading">
                <h6 class="mb-0">{{ $productdetails[0]->name }}</h6>
            </div>
            <!-- Navbar Toggler-->
    ...
    <div class="page-content-wrapper">
        <div class="product-slide-wrapper">
            ...
            <div class="product-slides owl-carousel">
                ...
                @foreach ($productdetails[0]->images as $item)
                    <div class="single-product-slide" style="background-image: url('/storage/{{ $item }}'); background-size:cover; background-position:center; background-repeat:no-repeat;"></div>
                @endforeach
            ...
            <div class="product-title-meta-data bg-white mb-3 py-3">
                <div class="container d-flex justify-content-between rtl-flex-d-row-r">
                    <div class="p-title-price">
                        <h5 class="mb-1">{{ $productdetails[0]->name }}</h5>
                        <p class="sale-price mb-0 lh-1">{{ $productdetails[0]->price }} TK<span></span></p>
                    </div>
                ...
                <div class="container d-flex align-items-center justify-content-between">
                    ...
                    <div class="choose-size-wrapper text-end">
                        ...
                        <div class="choose-size-radio d-flex align-items-center">
                            @foreach (explode(',', $productdetails[0]->size) as $size)
                                <!-- Single Radio Input-->
                                <div class="form-check mb-0 me-2">
                                    <input class="form-check-input" id="sizeRadio1" type="radio" name="sizeRadio">
                                    <label class="form-check-label" for="sizeRadio1">{{ trim($size) }}</label>
                                </div>
                            @endforeach
