        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div id="imagePreviewContainer" style="margin-top:10px;">
                    <img id="imagePreview" src="" alt="" style="display:none; max-width:150px; max-height:150px; border-radius:6px; border:1px solid #ccc;">
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addButton.addEventListener('click', async function (e) {
        ...
        addButton.innerHTML = '<span class="spinner-border spinner-border-sm"></span> Saving...';
        ...
        try {
            ...
            if (response.ok) {
                ...
                toastr.error(data.message || "❌ Failed to create category. Please check input and try again.");
            }
