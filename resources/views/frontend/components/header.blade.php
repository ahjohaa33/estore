        ...
        <div class="container h-100 d-flex align-items-center justify-content-between d-flex rtl-flex-d-row-r">
            ...
            <div class="navbar-logo-container d-flex align-items-center">
                ...
                <div class="user-profile-icon ms-2">
                    @auth
                        <a href="#">
                            <img src="{{ auth()->user()->avatar ? asset(auth()->user()->avatar) : asset('https://avatar.iran.liara.run/username?username=R+C') }}"
                                alt="{{ auth()->user()->name }}" style="object-fit:fill;border-radius:50%;">
                        </a>
                    @else
                        <a href="{{ route('userlogin') }}">
                            <img src="{{ asset('https://avatar.iran.liara.run/username?username=U') }}" alt="Guest"
